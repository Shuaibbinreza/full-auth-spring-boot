...
import com.practice.full_auth.security.request.LoginRequest;
import com.practice.full_auth.security.request.SignupRequest;
...
public class AuthController {
    ...
    public ResponseEntity<?> forgotPassword(@RequestParam String email) {
        try{
            ...
            e.printStackTrace();
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new MessageResponse("Error Sending Reset Email!"));
        }
    }
}
